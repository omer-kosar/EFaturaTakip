...
namespace EFaturaTakip.Entities.Migrations
{
    ...
    [Migration("20220611114112_RemoveAdressColumnsFromStockTable")]
    partial class RemoveAdressColumnsFromStockTable
    {
            ...
            modelBuilder.Entity("EFaturaTakip.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e741b641-8fbb-4712-add8-2f32d537f0fc"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("9bc98f2d-00a8-47bd-a0d3-f95336de64b5"),
                            Name = "TaxPayer"
                        },
                        new
                        {
                            Id = new Guid("69e05a15-e57e-4431-9de9-9eff5c9676cb"),
                            Name = "Accountant"
                        });
                });
